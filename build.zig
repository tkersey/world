...
pub fn build(b: *std.Build) void {
    ...
    forged_identity.expect_errors = .{
        .contains = "world.application owns the World 3.1.2 / Boundary 1.4.0 package identity",
    };
    ...
    const dependency_step = b.step("check-world-boundary-dependency", "Require the sole exact Boundary v1.4.0 package dependency.");
