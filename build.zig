...
pub fn build(b: *std.Build) void {
    ...
    forged_identity.expect_errors = .{
        .contains = "world.application owns the World 3.1.0 / Boundary 1.3.1 package identity",
    };
    ...
    const dependency_step = b.step("check-world-boundary-dependency", "Require the sole exact Boundary v1.3.1 package dependency.");
