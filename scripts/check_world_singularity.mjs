...
function checkSingularity(root) {
  const exact = new Map([
    ...
    ["test", ["application_build_options_test.zig", "application_v1_agent_fixtures.zig", "application_v1_fixture_app.zig", "application_v1_research_digest_test.zig", "application_v1_skeleton_app.zig", "application_v1_test.zig"]],
  ]);
