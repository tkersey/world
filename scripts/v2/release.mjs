...
if(!/^5\.0\.2(?:-dev\.0)?$/.test(version??''))throw new Error('unexpected World release version');
...
const assets=[{name:'world-process-kernel-v2.wasm',bytes:kernel},
  {name:'world-v5.0.2-process-runtime.tar.gz',bytes:archive},
...
assets.push({name:'world-v5.0.2-release-receipt.json',bytes:json(receipt)});
