...
function checkDependency(root) {
  ...
  for (const token of [
    '.version = "3.1.4"',
    ".boundary = .{",
    '.url = "https://github.com/tkersey/boundary/archive/f8d7acec64e5981871fa0bbd3436114e13ef5552.tar.gz"',
    '.hash = "boundary-1.6.0-flclaHP-HQCjjVmw66Hg9eRFLEPf7jIbgB8XieZ7P0vy"',
  ]) {
