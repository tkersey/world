...
export function validatePackageManifest(manifest) {
  ...
  assert(manifest.version === "4.1.2", "package version must be 4.1.2");
...
const FORBIDDEN_AMBIENT_SENTINELS = Object.freeze([
  ...
  "__WORLD_FORBIDDEN_FETCH_v1__",
  "__WORLD_FORBIDDEN_WEB_SOCKET_v1__",
  "__WORLD_FORBIDDEN_NAVIGATOR_v1__",
  "__WORLD_FORBIDDEN_XML_HTTP_REQUEST_v1__",
  "__WORLD_FORBIDDEN_EVENT_SOURCE_v1__",
  "__WORLD_FORBIDDEN_WEB_TRANSPORT_v1__",
]);
...
const analysisScanner = new Bun.Transpiler({
  ...
  define: {
    ...
    fetch: FORBIDDEN_AMBIENT_SENTINELS[11],
    WebSocket: FORBIDDEN_AMBIENT_SENTINELS[12],
    navigator: FORBIDDEN_AMBIENT_SENTINELS[13],
    XMLHttpRequest: FORBIDDEN_AMBIENT_SENTINELS[14],
    EventSource: FORBIDDEN_AMBIENT_SENTINELS[15],
    WebTransport: FORBIDDEN_AMBIENT_SENTINELS[16],
  },
});
