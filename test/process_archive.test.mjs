...
describe("World Process Host runtime archive", () => {
  test("builds byte-identically with canonical inventory, modes, checksums, and gzip", async () => {
    ...
    expect(runtimeReadme).toContain("https://github.com/tkersey/world/blob/v4.1.2/docs/process_host_v1.md");
    expect(runtimeReadme).toContain("https://github.com/tkersey/world/blob/v4.1.2/docs/security_model.md");
    expect(runtimeReadme).toContain("https://github.com/tkersey/world/blob/v4.1.2/docs/migration_from_world_3.md");
  ...
  test("preserves the historical Boundary lock separately from the current runtime kernel", async () => {
    ...
    expect(lock.boundaryVersion).toBe("1.8.2");
