...
test "World closes one Boundary Machine ABI v2 residual effect" {
    ...
    try std.testing.expectEqualStrings("1.3.1", OneEffectApp.Manifest.boundary_package_version);
    try std.testing.expectEqualStrings("3.1.0", OneEffectApp.Manifest.world_package_version);
