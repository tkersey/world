...
World 2 application authors update the dependency to World 3.1 and Boundary 1.3.1,
...
change because World now fixes World 3.1.0 and Boundary 1.3.1 package identity;
