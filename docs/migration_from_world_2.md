...
World 2 application authors update the dependency to World 3 and Boundary 1.0,
...
change because World now fixes World 3.0.0 and Boundary 1.0.0 package identity;
