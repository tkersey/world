...
World 2 application authors update the dependency to World 3.1 and Boundary 1.6.0,
...
change because World now fixes World 3.1.4 and Boundary 1.6.0 package identity;
