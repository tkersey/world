...
World 2 application authors update the dependency to World 3.2 and Boundary 1.7.0,
...
change because World now fixes World 3.2.0 and Boundary 1.7.0 package identity;
