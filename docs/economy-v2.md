...
is `0a8ee56c30384e8a86ca5ac238e3022dbe1954cf8c341d2983781d497bc23866`.
...
| Gate | Observation |
|---|---|
| Warm execution, at most 2× v1 | All seven matched workloads passed; worst median ratio 0.8737. |
...
| Cold compile and emission, at most 2× v1 | One effect: 1.3126×; 32 dependent additions: 1.2790×. |
...
|---|---:|---:|---:|
| Integer and Boolean operations | 0.06921 | 0.03192 | 0.4611 |
| Algebraic collections | 0.12110 | 0.05638 | 0.4656 |
| Portable values | 0.03598 | 0.01391 | 0.3867 |
| Recursion, initial zero | 0.32785 | 0.01448 | 0.0442 |
| Recursion, initial 32 | 10.64582 | 0.04677 | 0.0044 |
| Residual request | 0.04633 | 0.04048 | 0.8737 |
| Authored yield | 0.02352 | 0.01170 | 0.4976 |
...
682,943 and 388,452 bytes respectively.
...
388,452-byte kernel. Each JavaScript compilation uses a fresh process; each
